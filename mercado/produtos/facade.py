...
def listar_produtos_por_marca(marca):
    ...
    """
    return Produto.objects.filter(marca=marca).order_by('slug')
...
def listar_produtos_por_departamento(departamento):
    ...
    """
    return Produto.objects.filter(subcategoria__categoria__departamento__slug=departamento).order_by('slug')
...
def listar_produtos_por_categoria(categoria):
    ...
    """
    return Produto.objects.filter(subcategoria__categoria__slug=categoria).order_by('slug')
...
def listar_produtos_por_subcategoria(subcategoria):
    ...
    """
    return Produto.objects.filter(subcategoria__slug=subcategoria).order_by('slug')
